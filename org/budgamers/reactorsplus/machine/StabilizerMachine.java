...
public class StabilizerMachine extends BlockContainer {

	public static IIcon topIcon;
	public static IIcon sideIcon;
	public static IIcon frontIcon;
	
	public TileEntityStabilizer tileEntity;
	
	public int front = 3;
	
	public StabilizerMachine(Material p_i45386_1_) {
		super(p_i45386_1_);
	...
	public void registerBlockIcons(IIconRegister icon) {
		...
		frontIcon = icon.registerIcon(ReactorsPlus.MODID + ":stabilizer_front");
	}
	...
	public void onBlockAdded(World world, int x, int y, int z) {
		...
		this.tileEntity = (TileEntityStabilizer) world.getTileEntity(x, y, z);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int i, float a, float b, float c) {
		player.openGui(ReactorsPlus.instance, 1, world, x, y, z);
