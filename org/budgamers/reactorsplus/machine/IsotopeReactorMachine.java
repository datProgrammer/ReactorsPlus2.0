...
public class IsotopeReactorMachine extends BlockContainer {

	public static IIcon topIcon;
	public static IIcon sideIcon;
	public static IIcon frontIcon;
	
	public TileEntityIsotopeReactor tileEntity;
	
	public int front = 3;
	
	public IsotopeReactorMachine(Material p_i45386_1_) {
		super(p_i45386_1_);
		
		this.setBlockName("isotopeReactor");
	...
	public void registerBlockIcons(IIconRegister icon) {
		...
		frontIcon = icon.registerIcon(ReactorsPlus.MODID + ":isotope_front");
	}
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityIsotopeReactor();
	}
	...
	public void onBlockAdded(World world, int x, int y, int z) {
		...
		this.tileEntity = (TileEntityIsotopeReactor) world.getTileEntity(x, y, z);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int i, float a, float b, float c) {
		player.openGui(ReactorsPlus.instance, 3, world, x, y, z);
