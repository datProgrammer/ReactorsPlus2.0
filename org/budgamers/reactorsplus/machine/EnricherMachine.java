...
public class EnricherMachine extends BlockContainer {

	public static IIcon topIcon;
	public static IIcon sideIcon;
	public static IIcon frontIcon;
	
	public TileEntityEnricher tileEntity;
	
	public int front = 3;
	
	public EnricherMachine(Material p_i45386_1_) {
		super(p_i45386_1_);
		
		this.setBlockName("enricher");
	...
	public void registerBlockIcons(IIconRegister icon) {
		...
		frontIcon = icon.registerIcon(ReactorsPlus.MODID + ":enricher_front");
	}
	...
	public void onBlockAdded(World world, int x, int y, int z) {
		...
		this.tileEntity = (TileEntityEnricher) world.getTileEntity(x, y, z);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int i, float a, float b, float c) {
		player.openGui(ReactorsPlus.instance, 0, world, x, y, z);
