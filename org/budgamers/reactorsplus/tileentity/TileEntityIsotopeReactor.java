...
public class TileEntityIsotopeReactor extends TileEntity implements IInventory {
	...
	public TileEntityIsotopeReactor() {
	...
	public String getInventoryName() {
		return "container.isotopeReactor";
	}
	...
	public boolean canEnrich() {
		...
		ItemStack stack = MachineRecipes.isotopeReactor().getReactionResult(items[0].getItem());
	...
	public void enrichItem() {
		if(this.canEnrich()) {
			ItemStack stack = MachineRecipes.isotopeReactor().getReactionResult(this.items[0].getItem());
	...
	public static int getItemBurnTime(ItemStack stack) {
		...
		if(item == ReactorsPlusItems.oxygenCanister) {
			return 3840;
		} else {
			return 0;
		}
