...
public class TileEntityPlatingMachine extends TileEntity implements IInventory {
	...
	public TileEntityPlatingMachine() {
	...
	public String getInventoryName() {
		return "container.platingMachine";
	}
	...
	public boolean canEnrich() {
		...
		ItemStack stack = MachineRecipes.plating().getPlatingResult(items[0].getItem());
	...
	public void enrichItem() {
		if(this.canEnrich()) {
			ItemStack stack = MachineRecipes.plating().getPlatingResult(this.items[0].getItem());
	...
	public static int getItemBurnTime(ItemStack stack) {
		...
		if(item == ReactorsPlusItems.diamondEdgedBlade) {
			return 26400;
		} else {
			return 0;
		}
