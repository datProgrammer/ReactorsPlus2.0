...
public class TileEntityStabilizer extends TileEntity implements IInventory {
	...
	public boolean canEnrich() {
		...
		ItemStack stack = MachineRecipes.stabilize().getStabilizeResult(items[0].getItem());
	...
	public void enrichItem() {
		if(this.canEnrich()) {
			ItemStack stack = MachineRecipes.stabilize().getStabilizeResult(this.items[0].getItem());
	...
	public static int getItemBurnTime(ItemStack stack) {
		...
		if(item == ReactorsPlusItems.platinum) {
			return 26400;
		} else {
			return 0;
		}
