...
public class TileEntityEnricher extends TileEntity implements IInventory {
	...
	public boolean canEnrich() {
		...
		ItemStack stack = MachineRecipes.enrichment().getEnrichmentResult(items[0].getItem());
	...
	public void enrichItem() {
		if(this.canEnrich()) {
			ItemStack stack = MachineRecipes.enrichment().getEnrichmentResult(this.items[0].getItem());
	...
	public static int getItemBurnTime(ItemStack stack) {
		...
		if(item == ReactorsPlusItems.francium) {
			return 3840;
		} else {
			return 0;
		}
