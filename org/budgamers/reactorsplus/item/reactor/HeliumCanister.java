...
public class HeliumCanister extends Item implements IReactorComponent {

	public ItemStack thisItem;
	public int damage;
	
	public HeliumCanister() {
		super();
		
		this.thisItem = new ItemStack(this);
		this.setUnlocalizedName("heliumCanister");
		this.setTextureName(ReactorsPlus.MODID + ":helium_canister");
