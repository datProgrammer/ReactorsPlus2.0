...
public class OxygenCanister extends Item implements IReactorComponent {
	...
	public OxygenCanister() {
		...
		this.setUnlocalizedName("oxygenCanister");
		this.setTextureName(ReactorsPlus.MODID + ":oxygen_canister");
