...
public class NitrogenCanister extends Item implements IReactorComponent {
	
	public ItemStack thisItem;
	public int damage;
	
	public NitrogenCanister() {
		super();
		
		this.thisItem = new ItemStack(this);
		this.setUnlocalizedName("nitrogenCanister");
		this.setTextureName(ReactorsPlus.MODID + ":nitrogen_canister");
